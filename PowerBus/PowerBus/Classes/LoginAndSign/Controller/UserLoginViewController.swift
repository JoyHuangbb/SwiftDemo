...
//        self.fd_interactivePopDisabled = true
    ...
    @objc func faceBookButtonClick() {
        let vc = MobileLoginViewController.init(nibName: nil, bundle: nil)
    ...
    private lazy var loginLabel: UILabel = {
        let loginLabel = UILabel.init(frame: CGRect(x: ScreenWidth * 0.16, y: ScreenHeight * 0.17, width: 100, height: 18))
    ...
    private lazy var mobileButton: UIButton = {
        ...
        mobileButton.setTitle("手机号码登录", for: UIControlState.normal)
...
class LoginButton: UIButton {
    override func imageRect(forContentRect contentRect: CGRect) -> CGRect {
        return CGRect.init(x: 20, y: 9, width: 22, height: 22)
    }
    
    override func titleRect(forContentRect contentRect: CGRect) -> CGRect {
        return CGRect.init(x: 0, y: 9, width: self.width, height: 22)
    }
}
