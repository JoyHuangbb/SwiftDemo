//
//  BluetoothAuthRefusePopView.swift
//  PowerBus
//
...
class BluetoothAuthRefusePopView: PBBasePopView {
    ...
    @objc func timeGo() {
        ...
        if timeNum <= 0 {
            ...
            tipLabel.text = String(format: "%ld秒后关闭", timeNum)
        }
    }
    ...
    private lazy var messageLabel: UILabel = {
        ...
        messageLabel.text = "如不允许软件访问蓝牙权限将无法借还充电宝！"
        return messageLabel
    }()
}
