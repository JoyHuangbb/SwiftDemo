...
class ReturnOrderDetailVC: BaseViewController {
    ...
    override func initLayout() {
        ...
        self.creatSubLabel()
        if self.scroller.height - bottomHeight > 50 {//还有空间可以放空间
    ...
    private lazy var headView: UIView = {
        ...
        let test1 = NSAttributedString(string: "  归还成功", attributes: [kCTFontAttributeName as NSAttributedStringKey: UIFont.systemFont(ofSize: 20)])
        attri.append(text)
        attri.append(test1)
    ...
    private lazy var tip2Label: UILabel = {
        ...
        tip2Label.textColor = UIColor.hexadecimalColor(hexadecimal: "#868686")
