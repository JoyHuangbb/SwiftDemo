//
//  ReturnMachineViewController.swift
//  PowerBus
//
//  Created by 黄彬彬 on 2018/10/30.
//  Copyright © 2018年 黄彬彬. All rights reserved.
//
//  考虑到可能到租借和归还的逻辑比较复杂，所以将此类和LoanMachineViewController分开写

import UIKit

class ReturnMachineViewController: BaseViewController {
    ...
    @objc func refuseButtonClick() {
        HUDManager.show("尝试重新归还")
        let vc = ReturnOrderDetailVC.init(nibName: nil, bundle: nil)
    ...
    @objc func upLoadLabelButtonClick() {
        ...
        vc.errorType = UploadErrorType.ReturnMachineError.rawValue
        self.navigationController?.pushViewController(vc, animated: true)
    }
    ...
    private lazy var logoImageView: UIImageView = {
        ...
        logoImageView.image = UIImage.gifImageWithName("归还动画01")
    ...
    private lazy var refuseButton: UIButton = {
        ...
        refuseButton.setTitle("无法归还充电宝？", for: UIControlState.normal)
